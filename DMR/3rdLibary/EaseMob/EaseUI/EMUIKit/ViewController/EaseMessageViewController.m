...
#import "UIViewController+EMHUD.h"
...
{
//    NSString *nicknameF = [[DMRChatManager sharedManager] getUserModelWithConversationId:message.conversationId].nickname;
//    NSString *headurlF = [[DMRChatManager sharedManager] getUserModelWithConversationId:message.conversationId].avatarURLPath;
//    nicknameF = nicknameF ? nicknameF : message.to;
//    headurlF = headurlF ? headurlF : @"";
//    
...
//    }
//    message.ext = @{@"nickname" : MainTabBar.currentUser.nickname,
//                    @"headUrl" : MainTabBar.currentUser.head_img_url,
//                    @"nicknameF" : nicknameF,
//                    @"headUrlF" : headurlF
//                    };
