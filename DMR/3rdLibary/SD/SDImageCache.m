...
static const NSInteger kDefaultCacheMaxSize = 30*1024*1024;         // 30 M
...
{
    dispatch_async(self.ioQueue, ^{
//        [_fileManager removeItemAtPath:[CacheManager cacheDirectory] error:nil];
//        [_fileManager createDirectoryAtPath:[CacheManager cacheDirectory]
...
- (void)cleanDiskWithCompletionBlock:(SDWebImageNoParamsBlock)completionBlock {
    dispatch_async(self.ioQueue, ^{
        // 删除文字类缓存
//        [CacheManager removeOutTimeCache:kDefaultCacheMaxCacheAge];
