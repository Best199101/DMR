...
- (void)sd_setImageWithURL_Animation:(NSURL *)url placeholderImage:(UIImage *)placeholder {
//    [self sd_setImageWithURL:url placeholderImage:placeholder options:0 progress:nil completed:nil];
    [self sd_setImageWithURLWithAnimation:url placeholderImage:placeholder
                                  options:0
                                 progress:nil
                                completed:nil];
}
...
- (void)sd_setImageWithURLWithAnimation:(NSURL *)url
