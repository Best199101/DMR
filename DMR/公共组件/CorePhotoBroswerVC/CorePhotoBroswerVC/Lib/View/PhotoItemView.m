...
//    BOOL isNetWorkShow = YES;
    BOOL isNetWorkShow = _photoModel.image == nil;
//    if (_photoModel.image_HD_U == nil) {
//        isNetWorkShow = NO;
//    }
...
//        UIImage *image = [UIImage phImageWithSize:[UIScreen mainScreen].bounds.size zoom:.3f];
        UIImage *plimage = self.photoModel.sourceImageView.image;        
        UIImage *image = [UIImage phImageWithSize:[UIScreen mainScreen].bounds.size zoom:.3f WithPlaceholder:plimage];
    ...
    if(self.photoModel.isFromSourceFrame && self.type == PhotoBroswerVCTypeZoom){
        ...
        /**
         * springWithDamping 决定是否动弹
         */
        __weak __typeof(&*self)weakSelf = self;
        [UIView animateWithDuration:timeInterval delay:0 usingSpringWithDamping:1.f initialSpringVelocity:15 options:UIViewAnimationOptionCurveEaseInOut animations:^{
            
            weakSelf.photoImageView.frame = self.photoImageView.calF;
...
//        self.bottomView.alpha=0;
    ...
    /**
     * springWithDamping 决定是否动弹 1.0代表不动
     */
    [UIView animateWithDuration:.4f delay:0 usingSpringWithDamping:1.0f initialSpringVelocity:15 options:UIViewAnimationOptionCurveEaseInOut animations:^{
