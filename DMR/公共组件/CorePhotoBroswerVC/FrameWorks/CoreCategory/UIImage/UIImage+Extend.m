...
//    [self.assetsLibrary saveImage:self toAlbum:NSLocalizedString(@"66小区", nil) withCompletionBlock:completeBlock];
...
//{
//    return objc_getAssociatedObject(self,&assetsLibraryKey);
//}
