...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [self dmr_Fabric];
    [self dmr_RootViewControllerWithIsSlip:NO];
    
    _synchronizeManager = [SynchronizeManager new];
    
//    self.window = [[UIWindow alloc]initWithFrame:[UIScreen mainScreen].bounds];
//    _DMRMainController = [DMRTabBarController new];
////    UINavigationController *mainNavigationController = [[UINavigationController alloc]initWithRootViewController:_DMRMainController];
...
////    [mmDrawerController setMaximumRightDrawerWidth:DeviceWidth];
...
//    self.window.rootViewController = _DMRMainController;
